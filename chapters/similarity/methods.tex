...
permutate values in i columns in the second dataset\\


\For {target in dataset columns}{
\begin{itemize}
    \item Train-Test Split (95:5) \\
    \item model fit to train \\
    \item get feature importance per column \\
    \item Create an ordered rank of features \\
    \item Apply new metrics for comparison \\
...
\end{itemize}
 ...
 \caption{Testing similarity scores in tabular datasets. Dataset list is the 5 datasets used in this work. ML algorithms are the 6 ML algorithms used in this work. Number of columns to test is the number of columns in the dataset. 10 repetitions is the number of times the columns are permutated.}
\end{algorithm}
